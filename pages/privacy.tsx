...
export default function Privacy() {
  return (
    <Container title="Privacy Policy – Sayan Dey">
      <div className="flex flex-col justify-center text-black dark:text-white items-start max-w-[45rem] mx-auto mb-16 w-full">
        <h1 className="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-black dark:text-white">
          Privacy Policy
        </h1>
        <div className="w-full mt-4 prose dark:prose-dark max-w-none">
          <p className="mb-b text-gray-800 dark:text-gray-200">
            <strong>Last updated:</strong> September 04, 2023
          </p>
          <p className="mb-b text-gray-800 dark:text-gray-200">
          ...
          <h2 className="font-black">Interpretation and Definitions</h2>
          ...
          <ul>
            ...
            <li>
              Website refers to Sayan Dey, accessible from{' '}
              <Link href="/">https://sayandey.dev</Link>
            </li>
            <li>
          ...
          <h2 className="font-black">Children's Privacy</h2>
          <p className="mb-b text-gray-800 dark:text-gray-200">
          ...
          <h2 className="font-black">Links to Other Websites</h2>
          <p className="mb-b text-gray-800 dark:text-gray-200">
          ...
          <h2 className="font-black">Changes to this Privacy Policy</h2>
          <p className="mb-b text-gray-800 dark:text-gray-200">
          ...
          <ul>
            <li>By email: sayan[at]sayandey[dot]dev</li>
            <li>
              By visiting this page on our website:{' '}
              <Link href="/contact">https://sayandey.dev/contact</Link>
            </li>
          </ul>
        </div>
      </div>
